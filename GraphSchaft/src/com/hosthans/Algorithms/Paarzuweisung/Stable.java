...
public class Stable {
    ...
    static List<String> girls = Arrays.asList(
            new String[]{
                    "abi", "bea","eve", "fay", "gay", "hope", "ivy", "jan"});
            ...
            new HashMap<String, List<String>>(){{
                ...
                put("cath",
                        Arrays.asList("fred", "bob", "ed", "gav", "hal", "col", "ian",
                                "abe", "dan", "jon"));
                put("dee",
                        Arrays.asList( "hal", "gav",
                                "dan", "bob", "ed"));
                put("eve",
                        Arrays.asList("jon", "hal", "fred", "dan", "abe", "gav", "col",
                                "ed", "ian", "bob"));
                put("fay",
                        Arrays.asList("jon", "dan", "fred",
                                "gav", "col", "hal"));
                put("gay",
                ...
                put("hope",
                        Arrays.asList("gav", "jon", "bob", "abe", "ian", "dan", "hal",
                                "ed", "col", "fred"));
                put("ivy",
                        Arrays.asList("ian", "bob", "abe",
                                "ed", "jon", "dan"));
                put("jan",
                        Arrays.asList("ed","jon", "col",
                                "ian", "fred", "dan"));
            }};
